...
ALTER TABLE authentication_codes ADD COLUMN IF NOT EXISTS label_used BOOLEAN DEFAULT FALSE;
ALTER TABLE authentication_codes ADD COLUMN IF NOT EXISTS label_used_at TIMESTAMP NULL DEFAULT NULL;
ALTER TABLE product_labels ADD COLUMN IF NOT EXISTS template_id INT NULL;
